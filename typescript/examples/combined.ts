...
assertEquals(await policy.value('free_user', 'usage') as number, 20); // always units of credit (MB)
...
assertEquals(await policy.value('cus_alt', 'curie_tokens') as number, 13200); // already had 1k from above
